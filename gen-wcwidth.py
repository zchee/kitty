...
def parse_ucd() -> None:
    ...
    # for line in get_data_raw('https://unicode.org/Public/UCD/latest/ucd/UnicodeData.txt'):
...
def parse_eaw() -> None:
    ...
    for line in get_data_raw('https://unicode.org/Public/14.0.0/ucd/EastAsianWidth-14.0.0d5.txt'):
