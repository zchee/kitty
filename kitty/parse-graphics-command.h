  ...
  while (pos < screen->parser_buf_pos) {
    ...
    case FLAG:
      ...
      case action: {
        ...
        if (g.action != 't' && g.action != 'p' && g.action != 'q' &&
      ...
      case delete_action: {
        ...
        if (g.delete_action != 'I' && g.delete_action != 'Q' &&
            g.delete_action != 'Z' && g.delete_action != 'c' &&
            g.delete_action != 'p' && g.delete_action != 'P' &&
            g.delete_action != 'A' && g.delete_action != 'x' &&
            g.delete_action != 'i' && g.delete_action != 'q' &&
      ...
      case transmission_type: {
        ...
        if (g.transmission_type != 't' && g.transmission_type != 'd' &&
            g.transmission_type != 'f' && g.transmission_type != 's') {
          REPORT_ERROR("Malformed GraphicsCommand control block, unknown flag "
