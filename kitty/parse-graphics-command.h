  ...
  while (pos < screen->parser_buf_pos) {
    ...
    case FLAG:
      ...
      case delete_action: {
        ...
        if (g.delete_action != 'y' && g.delete_action != 'A' &&
            g.delete_action != 'I' && g.delete_action != 'c' &&
            g.delete_action != 'a' && g.delete_action != 'q' &&
            g.delete_action != 'Q' && g.delete_action != 'Z' &&
            g.delete_action != 'x' && g.delete_action != 'Y' &&
            g.delete_action != 'C' && g.delete_action != 'P' &&
