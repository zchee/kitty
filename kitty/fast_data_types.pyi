...
@overload
def compile_program(which: int, allow_recompile: bool = False) -> int:
    pass
...
def get_fallback_font(text: str, bold: bool, italic: bool, emoji_presentation: bool = False) -> Any:
    pass
