...
static PyMethodDef module_methods[] = {
    ...
    {"renderer_backend_register_stub_for_tests", (PyCFunction)py_renderer_backend_register_stub_for_tests, METH_VARARGS, ""},
    {"renderer_backend_render_for_tests", (PyCFunction)(void (*)(void))py_renderer_backend_render_for_tests, METH_VARARGS | METH_KEYWORDS, ""},
    {"renderer_backend_present_for_tests", (PyCFunction)(void (*)(void))py_renderer_backend_present_for_tests, METH_VARARGS | METH_KEYWORDS, ""},
