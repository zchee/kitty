// Unicode data, built from the Unicode Standard 15.1.0
...
wcwidth_std(int32_t code) {
	...
	switch(code) {
		...
		// Emoji Presentation (20 codepoints) {{{
		case 0x1f6dc:
			return 2;
		case 0x1fa75 ... 0x1fa77:
			return 2;
		case 0x1fa87 ... 0x1fa88:
			return 2;
		case 0x1faad ... 0x1faaf:
			return 2;
		case 0x1fabb ... 0x1fabd:
			return 2;
		case 0x1fabf:
			return 2;
		case 0x1face ... 0x1facf:
			return 2;
		case 0x1fada ... 0x1fadb:
			return 2;
		case 0x1fae8:
			return 2;
		case 0x1faf7 ... 0x1faf8:
			return 2;
		// }}}

		// Not assigned in the unicode character database (760466 codepoints) {{{
		case 0x378 ... 0x379:
			return -4;
		case 0x380 ... 0x383:
			return -4;
...
#define UNICODE_MINOR_VERSION 1
