...
def kitty_env() -> Env:
    ...
    if is_macos:
        ans.cflags.append('-isystem{}'.format(glfw.macos_isystem()))
        ans.cflags.append('-isysroot{}'.format(glfw.macos_isysroot()))
...
def build_launcher(args: Options, launcher_dir: str = '.', bundle_type: str = 'source') -> None:
    ...
    cflags.append('-Ofast')
    cflags.append('-flto')
    cflags.append('-isystem{}'.format(glfw.macos_isystem()))
    cflags.append('-isysroot{}'.format(glfw.macos_isysroot()))
...
def macos_info_plist() -> bytes:
    ...
    pl = dict(
        ...
        NSAppleEventsUsageDescription='An application in kitty would like to access AppleScript.',
        NSCalendarsUsageDescription='An application in kitty would like to access calendar data.',
        NSCameraUsageDescription='An application in kitty would like to access the camera.',
        NSContactsUsageDescription='An application in kitty wants to access your contacts.',
        NSLocationAlwaysUsageDescription='An application in kitty would like to access your location information, even in the background.',
        NSLocationUsageDescription='An application in kitty would like to access your location information.',
        NSLocationWhenInUseUsageDescription='An application in kitty would like to access your location information while active.',
        ...
        NSSystemAdministrationUsageDescription='An application in kitty requires elevated permissions.',
